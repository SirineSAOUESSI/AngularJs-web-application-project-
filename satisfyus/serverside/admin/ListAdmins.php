...
$sql = "SELECT administrateur.id_utilisateur,administrateur.id_admin,administrateur.Nom,administrateur.Prenom,utilisateur.Email,utilisateur.MDP,administrateur.Tel,administrateur.Adresse,administrateur.sexe,administrateur.Description,administrateur.Date_Naiss,administrateur.Photo  FROM administrateur,utilisateur where utilisateur.id_utilisateur=administrateur.id_utilisateur";
