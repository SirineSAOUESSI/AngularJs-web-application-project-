(function() {
  ...
  angular.module('builder.controller', ['builder.provider']).directive('fileModel', ['$parse', function ($parse) {
    return {
    restrict: 'A',
  ...
  this.uploadFileToUrl = function(file, uploadUrl, name){
    ...
    '$scope', '$injector','fileUpload', function($scope, $injector,fileUpload) {
      var $builder;
      ...
      $scope.setupScope = function(formObject) {
        ...
        $scope.$watch('[label, description, placeholder, required, options, validation,value,res]', function() {
          formObject.label = $scope.label;
          formObject.res= $scope.res;
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertComponent = function(name, component) {
      ...
      result = {
        ...
        value: (_ref10 = component.value) != null ? _ref10 : '',
        res: (_ref1 = component.res) != null ? _ref11 : '',
    ...
    this.convertFormObject = function(name, formObject) {
      var component, result, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7,_ref10,_ref11,_ref12;
      if (formObject == null) {
        formObject = {};
      }
      ...
      result = {
        ...
        value: (_ref10 = formObject.value) != null ? _ref10 : component.value,
        res: (_ref11 = formObject.res) != null ? _ref11 : component.value,
